      ...
      <Stack direction='column' size='large'>
        <header style={{ width: '100%' }}>
          <Stack block direction='column' size='large'>
            <a href='/'>
              <img
                src='https://res.cloudinary.com/albin-groen/image/upload/v1594585514/Frame_1-3_hesjam.png'
                width={150}
                alt='Basikit Logo'
              />
            </a>
            <Stack direction='column' size='large'>
              ...
              <Stack direction='column' size='small'>
                ...
                <p style={{ maxWidth: 600 }}>
                  ...
                  accessible user interface up and running as fast as possible.
                </p>
              </Stack>
            </Stack>
            ...
            <Stack direction='column'>
              ...
              <List
                items={[
                  ...
                  {
                    key: 3,
                    title: '⏱ Saves time when bootstrapping software products.'
                  },
                  {
                    key: 4,
                    title: '🌍 Fully open source through git version control.'
                  }
                ]}
            ...
            <Card id='app-container' block>
              <Stack direction='column' size='large'>
                <Stack direction='column' size='small'>
                  ...
                  <Divider spacing='medium' />
                  <p style={{ maxWidth: '80ch' }}>
                    If you want utility functions like notifications, toasts and
                    modals to work for example, you need to wrap your app in our
                    Container component. This ensures the necessary context is
                    accessible for the components.
                  </p>
                </Stack>
              ...
              <Stack direction='column' size='large'>
                <Stack direction='column' size='small'>
                  ...
                  <p style={{ maxWidth: '80ch' }}>
                    ...
                    Primary, Error and Link. It has all the default HTML Button
                    attributes and should be used when a user wants to make any
                    sort of action.
                  </p>
                </Stack>
                ...
                <Stack direction='column' block>
                  ...
                  <table className='table'>
                    ...
                    <tr>
                      ...
                      <td>
                        <code>'default' | 'primary' | 'success' | 'error'</code>
                      </td>
                      <td>
                        <code>false</code>
                      </td>
            ...
            <Card id='popover' block>
              <Stack direction='column' size='large'>
                <Stack direction='column' size='small'>
                  ...
                  <Divider spacing='medium' />
                  <p style={{ maxWidth: '80ch' }}>
                    The popover component is a component to use when you quickly
                    want to display some information or let the user be able to
                    quickly create something without having to go another page.
                  </p>
                </Stack>
            ...
            <Card id='dropdown' block>
              <Stack direction='column' size='large'>
                <Stack direction='column' size='small'>
                  ...
                  <Divider spacing='medium' />
                  <p style={{ maxWidth: '80ch' }}>
                    The dropdown component is a component that you can use when
                    you want a user to pick a option from several alternatives.
                    For example this could be useful in a navigation bar when
                    clicking the profile picture.
                  </p>
                </Stack>
            ...
            <Card id='toast' block>
              <Stack direction='column' size='large'>
                <Stack direction='column' size='small'>
                  ...
                  <Divider spacing='medium' />
                  <p style={{ maxWidth: '80ch' }}>
                    The toast component is a component that should be used when
                    you want to quickly display some short information about if
                    a action has succeeded or failed for some reason. It is not
                    the same as a notification.
                  </p>
                </Stack>
              ...
              <Stack direction='column' size='large'>
                <Stack direction='column' size='small'>
                  ...
                  <p style={{ maxWidth: '80ch' }}>
                    ...
                    able to fill out some information or choose a action without
                    having to go to another page. Use this if there is too much
                    information for a popover but not enough to have a separate
                    page.
                  </p>
                </Stack>
              ...
              <Stack direction='column' size='large'>
                <Stack direction='column' size='small'>
                  ...
                  <p style={{ maxWidth: '80ch' }}>
                    ...
                    to highlight some really basic information to the user at a
                    quick glance. For example, if you have a button with only an
                    icon this might be helpful.
                  </p>
                </Stack>
            ...
            <Card id='table' style={{ width: '100%' }}>
              <Stack direction='column' size='large'>
                <Stack direction='column' size='small'>
                  ...
                  <Divider spacing='medium' />
                  <p style={{ maxWidth: '80ch' }}>
                    The table component is really useful if you want to display
                    structured data to a user. For example if you have an array
                    of products or customers, this is a good component for
            ...
            <Card id='checkbox' style={{ width: '100%' }}>
              <Stack direction='column' size='large'>
                <Stack direction='column' size='small'>
                  ...
                  <Divider spacing='medium' />
                  <p style={{ maxWidth: '80ch' }}>
                    The checkbox component should be used when you want users to
                    agree on some sort of condition. Or for example when you
                    want to add filters for a table, the checkbox is a good
                    component.
                  </p>
                </Stack>
            ...
            <Card id='input' style={{ width: '100%' }}>
              <Stack direction='column' size='large'>
                <Stack direction='column' size='small'>
                  ...
                  <Divider spacing='medium' />
                  <p style={{ maxWidth: '80ch' }}>
                    The input component should be used when you want to collect
                    some sort of text information from a user. For example when
                    signing up or logging in and you want them to enter a email
                    and password.
                  </p>
                </Stack>
                ...
                <Stack direction='column' block>
                  ...
                  <table className='table'>
                    ...
                    <tr>
                      ...
                      <td>
                        <code>{'(item: YourItemType) => React.ReactNode'}</code>
                      </td>
                      <td>
                        <code>true</code>
                      </td>
              ...
              <Stack direction='column' size='large'>
                <Stack direction='column' size='small'>
                  ...
                  <p style={{ maxWidth: '80ch' }}>
                    ...
                    want to display some sort of a profile picture or logo. Just
                    be aware that only square logos with only a icon will look
                    good on the avatar component.
                  </p>
                </Stack>
                ...
                <Stack direction='column' block>
                  ...
                  <table className='table'>
                    ...
                    <tr>
                      ...
                      <td>
                        <code>'default' | 'primary' | 'error' | 'success'</code>
                      </td>
                      <td>
                        <code>false</code>
                      </td>
              ...
              <Stack direction='column' size='large'>
                <Stack direction='column' size='small'>
                  ...
                  <p style={{ maxWidth: '80ch' }}>
                    ...
                    which direction it should list the elements, as well as how
                    much spacing should be added between each element.
                  </p>
                </Stack>
              ...
              <Stack direction='column' size='large'>
                <Stack direction='column' size='small'>
                  ...
                  <p style={{ maxWidth: '80ch' }}>
                    ...
                    display for the user the progress they or some other entity
                    has made over a period of time. For example the progress on
                    a course or the downloading of a file.
                  </p>
                </Stack>
              ...
              <Stack direction='column' size='large'>
                <Stack direction='column' size='small'>
                  ...
                  <p style={{ maxWidth: '80ch' }}>
                    ...
                    state. For example when you are loading data onto a page or
            ...
            <Card id='notification' block>
              <Stack direction='column' size='large'>
                <Stack direction='column' size='small'>
                  ...
                  <Divider spacing='medium' />
                  <p style={{ maxWidth: '80ch' }}>
                    The notification utility is good if you want to deliver some
                    sort of important message to the user. For example an error
                    that occurs after some sort of user action, or a more
            ...
            <Card id='message' block>
              <Stack direction='column' size='large'>
                <Stack direction='column' size='small'>
                  ...
                  <Divider spacing='medium' />
                  <p style={{ maxWidth: '80ch' }}>
                    The message utility is good if you want to deliver some sort
                    of important message to the user. For example an error that
                    occurs after some sort of user action, or a less complex
                    success message.
                  </p>
                </Stack>
